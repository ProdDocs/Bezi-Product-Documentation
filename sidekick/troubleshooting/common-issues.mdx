...
### I tried to open Sidekick but it was stuck on the splash screen. How do I get past this?&#x20;

This happens when the app version is out of date and the auto-update wasn't able to execute. Follow these steps to manually update the app:
...
If that doesn’t work, go to [https://bezi.com/start?source=sidekick](https://bezi.com/start?source=sidekick) to manually download the latest version of Sidekick app