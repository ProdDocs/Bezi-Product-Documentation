...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ceFoZS9dUWE?si=-qomzoCR-RQxX-kG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<AccordionGroup>
  <Accordion title="Creating a component" defaultOpen={false}>
    ...
    2. Right click on the desired object or group, then select **Create a component** from the dropdown![](/images/create-component.png)
  </Accordion>
  ...
  <Accordion title="Unlinking an instance" defaultOpen={false}>
    ...
    3. Select the instance, navigate to the 'Instance' section of the Properties Panel, then select the **Unlink instance** icon next to the instance name![](/images/component-unlink-instance.png)
  </Accordion>
  ...
  <Accordion title="Navigating to the main component from an instance" defaultOpen={false}>
    ...
    ![](/images/locate-main-component.png)
  </Accordion>
