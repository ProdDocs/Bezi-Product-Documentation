---
title: "View Prototypes in Headset"
description: "Open and interact with Editor prototypes in any XR headset using either method."
---
...
3. Select **Headset** from the device options
...
8. Select **Play** in the headset to move into immersive view

![](/images/bezi-connect.png)
...
3. Find and open the Editor file in the VR headset browser

4. Using controllers, click the **Play** dropdown in the top toolbar to view device options&#x20;

5. Using controllers, select **Headset** from the device options