...
The Asset Library collection has an assortment of standardized assets. If you're looking for a more specific or detailed asset, [Generate](https://docs.bezi.com/editor/editor-basics/asset-generation) can deliver custom 3D models in a few minutes. &#x20;
...
<AccordionGroup>
  <Accordion title="Accessing the Asset Library" defaultOpen={false}>
    ...
    3. The Asset Library modal will open, covering the scene![](/images/asset-library.png)
  </Accordion>
  ...
  <Accordion title="Adding library assets to a scene" defaultOpen={false}>
    ...
    3. Voila! The asset is now placed and ready to go![](/images/add-library-asset-to-scene.png)
  </Accordion>
</AccordionGroup>
