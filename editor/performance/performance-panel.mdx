...
<iframe width="560" height="315" src="https://www.youtube.com/embed/4JrmiEcUFCk?si=nrddBMFtIduiNPEh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<Tabs>
  <Tab title="Object selection & overview">
    ...
    ![](/images/performance-object-selection-overview.png)
  </Tab>
  ...
  <Tab title="Object view">
    ...
    ![](/images/performance-object-view.png)
  </Tab>
  ...
  <Tab title="Right-side viewport">
    ...
    ![](/images/performance-right-viewport.png)
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="Object selection">
    ...
    ![](/images/performance-secondary-object-select.png)
  </Tab>
  ...
  <Tab title="Instance selection">
    ...
    ![](/images/performance-secondary-instance-select.png)
  </Tab>
</Tabs>
