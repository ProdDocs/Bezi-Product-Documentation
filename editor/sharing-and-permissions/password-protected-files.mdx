...
<Steps>
  ...
  <Step title="Setting an expiration date">
    ...
    <Info>
      The expiration time and date is set in the file owner's current time zone.
    </Info>

    ![](/images/set-password-expiration-date.png)
  </Step>

  <Step title="Removing a password">
    To remove access with a password, uncheck the ‘Enable viewer access for anyone with a password’ box. After this, anyone not added directly to the file will lose access to viewing it.&#x20;
  </Step>
</Steps>
