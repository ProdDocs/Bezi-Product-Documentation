...
Teams are a helpful for collaboration and organization across files and shared libraries. All team members can access the files, material styles, and components that live in the team folder. To learn more about how assets are shared within teams, visit the [Team Library documentation](https://docs.bezi.com/editor/sharing-and-permissions/teams).
