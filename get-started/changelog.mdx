...
<Card title="Download Bezi plugin v0.67.1" icon="download" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.67.1/com.bezi.sidekick-0.67.1.tgz">
...
<Update label="09/30/2025" description>
  **_When you use Bezi to help with game development, memory is crucial. You want it to remember the core premise of your game, a great implementation plan from another thread, or a mechanic’s original state to track changes._**
  ...
  _We built _[_Pages_](https://docs.bezi.com/bezi/product/pages-folders)_ so you have the power to inject and reinforce these key details without repeating yourself or copy/pasting. Save longer-form project information in Pages and tag them in threads/prompts when a given task builds on them._
