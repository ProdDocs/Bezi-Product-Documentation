...
<Steps>
  ...
  <Step title="Customize your Workspace" stepNumber={6}>
    - [Add relevant data sources](https://docs.bezi.com/context/connections): connect Bezi to  other projects and external data sources
    - Import or create all the documentation for your agent
