...
Bezi is an AI game dev assistant. It's custom Unity integration enables complete, real-time project context (scripts, scenes, prefabs, assets, packages and more), used to plan and implement changes directly in the Unity Editor.
