...
Canvas is available in **Ask Mode** and **Agent Mode** and is accessed differently in both. To close in either situation, just select the `X` in the top bar.
...
When working in Agent Mode, Canvas is great for seeing changes in the context of the entire script and keep or undo them from there.
