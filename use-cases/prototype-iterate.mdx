...
<Steps>
  ...
  <Step title="Test and iterate" stepNumber={4}>
    When the agent is done working, click into the editor to test it in action. 

    Continue moving between Bezi and the editor, iterating on the mechanic and seeing the changes in action instantly.
  </Step>
</Steps>
