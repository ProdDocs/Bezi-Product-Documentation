...
[******Any UI-related work needs a Page where the standards and guidelines are defined******](https://docs.bezi.com/context/pages). Pin the UI Page(s) whenever you're doing relevant work to ensure Bezi has all the information it needs.
