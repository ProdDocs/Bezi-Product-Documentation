...
Bezi creates UI using [Actions](https://docs.bezi.com/fundamentals/agent-mode-actions) to spawn gameObjects, set up functionality, and create prefabs. It uses its native Vision tool to automatically check its work against references, to ensure speed and quality. 
