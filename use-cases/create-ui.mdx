...
Bezi is tuned well to implement UI using [Actions](https://docs.bezi.com/fundamentals/agent-mode-actions) to spawn gameObjects, set up functionality, and create prefabs. It has in-editor vision to automatically check its work against references, to ensure speed and quality.
...
2. Create your UI Standards Page, ref the below [framework and example](https://docs.bezi.com/use-cases/create-ui#precursor-for-creating-ui-with-bezi)
...
5. Define any customizations and functionality _specific_ to this UI that shouldn't live in your UI Standards Page
6. Pin any existing assets you want to use, e.g. textures, icons, etc.
7. \[[**Agent Mode**](https://docs.bezi.com/bezi/modes/agent-mode)\] Draft a prompt with all the information in Steps 1-6. [**<u>Pin</u>**](https://docs.bezi.com/context/pins) the UI Standards Page created in Step 2 (type `@`, then Page name) and attach images from Step 4
...
9. Bezi will create the UI prefab and functionality directly in the Unity Editor
10. Bezi will take images of the UI and iterate on look and feel until it gets close to the specs
11. Manually polish the UI to get it to 100%
...
// Handle click
    ...
    **Pressable:** Manipulator for press and long-press gestures.
    ...
    - Debug with UI Debugger tool for style and hierarchy inspection
  </Accordion>
</AccordionGroup>
