...
<Note>
  ___Bezi isn't trained to create pixel-perfect hierarchy canvas, visual assets, or polish yet. We’re working towards this, but the complexity and nuance of UI and the variance in any LLM-based response makes it impossible for any LLM-based tool to promise it could build UI 100% to-spec right now___.
</Note>
