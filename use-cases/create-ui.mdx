...
Bezi is tuned well to implement UI, using pre-built [Skills](/fundamentals/skills) and [Actions](https://docs.bezi.com/fundamentals/agent-mode-actions). It uses in-editor vision to automatically check work against references, for  speed and quality.
