...
Bezi is tuned well to implement UI using [Actions](https://docs.bezi.com/fundamentals/agent-mode-actions) to spawn gameObjects, set up functionality, and create prefabs. It uses in-editor vision to automatically check work against references, for  speed and quality.
