...
You don’t need to think in terms of actions - natural language works best.

- “Create a Player prefab with a Rigidbody and BoxCollider.”
- “Add a CapsuleCollider to all enemies in the current scene.”
- “Create a new ScriptableObject for weapon stats and link it to this prefab.”
- “Reorganize these UI elements into a vertical layout.”

For more deterministic behavior, be explicit:
