...
It's packaged in a folder with instructions and any required scripts or reference files. The instructions define the sequence of steps taken when the skill is invoked. A single skill can include any combination of the following:
...
- **Implement UGUI \[default\]** - Build UI using UGUI from a screenshot or Figma file.
- **UGUI to UI Toolkit** **\[default\]** - Convert UGUI canvas-based screens to UI Toolkit.
