...
It's packaged in a folder with instructions and any required scripts or reference files. The instructions are executed as a defined sequence of steps whenever the skill is invoked. A single skill can include any combination of the following:
