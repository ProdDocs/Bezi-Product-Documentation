...
Select the **mode dropdown** in the prompt textbox and select **Agent**. Agent Mode auto-implements suggestions in the editor so it's easy to test them in the game before deciding to keep them. 
