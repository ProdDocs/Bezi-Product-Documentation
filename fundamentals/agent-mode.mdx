...
Generally speaking, if you can do something in the Editor, Bezi Agent Mode can do it for you. 
...
Agent Mode is capable of doing nearly anything a human can do in-engine. It automatically deploys Actions and/or code to complete any type of task. Examples include:
...
When you prompt Bezi in Agent Mode, actions are auto-deployed. If the task requires an action that doesn't exist yet, you may be prompted to create a reusable [Custom Action](/fundamentals/custom-actions). 
