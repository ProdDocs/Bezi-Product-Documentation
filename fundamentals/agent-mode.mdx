...
Generally speaking, if you as a user can do something in the Editor, Bezi can do it for you. 
...
Bezi Agent Mode can is capable of doing nearly anything a human can do in-engine. It uses Actions to take this create, update, and organize editor scenes. Multiple actions are chained to complete complex tasks.
