...
Bezi does not use an MCP to connect and implement changes in the editor. MCP's standardized method delivers unreliable results at scale and requires ongoing maintenance by the user.
