...
Bezi Agent Mode is capable of doing nearly anything a human can do in-engine. It uses Actions to take this create, update, and organize editor scenes. Multiple actions are chained to complete complex tasks.
