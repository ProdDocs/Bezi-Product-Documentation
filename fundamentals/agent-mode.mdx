...
Bezi Agent Mode can is capable of doing nearly anything a human can do in-engine. It uses Actions to create, update, and organize editor scenes. Multiple actions are chained to complete complex tasks.

When you prompt Bezi in Agent Mode, actions will be auto-deployed based on intent. It will either use pre-built Actions or prompt you to create reusable [Custom Actions](/fundamentals/custom-actions) for everything else. 

#### Unity Pre-Built Action Examples
...
Bezi Agent Mode can automatically create, update, and organize editor scenes. Multiple actions are chained to complete complex tasks. 
