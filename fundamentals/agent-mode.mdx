...
Bezi Agent Mode is used to implement changes directly in the editor, automatically.

Bezi has complete access to the engines' editors. Generally speaking, if you as a user can do something in the Editor, Bezi can do it for you. 
...
Bezi can automatically create, update, and organize editor scenes without code. 

When you prompt Bezi in Agent Mode, actions will be auto-deployed based on intent. It will either use a pre-built Action or prompt you to create a reusable [Custom Action](/fundamentals/custom-actions) for everything not provided in Bezi. 

Multiple actions will be chained to complete complex tasks. For more control, explicitly name the action(s) you want in your prompt, e.g. _"Use Actions to create a prefab from @\[gameObject\]."_
