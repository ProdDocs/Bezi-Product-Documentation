...
Bezi Agent Mode is capable of doing nearly anything a human can do in-engine. It uses a combination of Actions and tools behind the scenes to complete complex tasks.
