...
Bezi does not use an MCP to connect and implement changes in the editor. MCP's standardized method delivers unreliable results, has inefficient token use, and requires ongoing maintenance by the user. The Editor integration is customized per engine to provide more accurate, reliable results.
