...
| ------------------ | -------------------------- | ------------------------------------------------------------- |
| **Frontier**       | Claude Opus, Gemini Pro    | Complex, multi-step workflows requiring accuracy or reasoning |
| **Core** (default) | Claude Sonnet              | Most tasks - balanced speed and reasoning                     |
| **Basic**          | Claude Haiku, Gemini Flash | Quick questions, small edits, lookups                         |
