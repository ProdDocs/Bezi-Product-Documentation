...
Plan Mode transforms an idea or request into clear, detailed prompt sequences for more consistent results. Use Plan Mode to scope a task completely, then set Bezi to execute on it while you work on something entirely different.
