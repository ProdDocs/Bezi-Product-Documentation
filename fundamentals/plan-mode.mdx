...
Plan Mode transforms an idea or request into clear, detailed prompt sequences for consistent results without babysitting. Scope a task completely in Plan Mode and Bezi can execute on it while you turn attention elsewhere.

## What can Plan Mode do?

Plan Mode is best for working on medium-to-complex tasks, which benefit from being broken into structured steps before building.
