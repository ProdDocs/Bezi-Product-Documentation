...
<AccordionGroup>
  ...
  <Accordion title="Creating an instance of a component" defaultOpen={false}>
    ...
    There are four ways to create an instance of an existing component. The instance will be created in the exact same position as the component, so make sure to&#x20;
