...
<Tabs>
  ...
  <Tab title="Right-side viewport">
    When a selected asset is being inspected the panels Geometry or Materials sections, a viewport will appear on the right side to display a detailed view of the asset. This can be used to gather insight into the asset or link to other linked root properties.
  </Tab>
