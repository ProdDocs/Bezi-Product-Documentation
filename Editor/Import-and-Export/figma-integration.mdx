...
Return to Figma and copy the link to the Figma frame that will be used as the texture. To copy a Figma frame link: *right click on the frame in Figma, go to 'Copy/Paste as', select **Copy Link***.

<Info>
  Figma frame links look like this: https://www.figma.com/file/SmJBaMhb9NxVp7du2Yu7fJ/Untitled?node-id=13%3A6809\&t=WKuHiWzeagpLm0QZ-4
</Info>
