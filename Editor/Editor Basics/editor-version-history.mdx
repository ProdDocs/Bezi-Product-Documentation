...
1. Click the **search** icon in the toolbar, type ‘version’, and select 'show version history' from the dropdown

2. Click the **search** icon in the toolbar, hover over **file** in the dropdown, and select **show version history**
...
1. Click the **search** icon in the toolbar, type ‘version’, and select 'save to version history' from the dropdown
