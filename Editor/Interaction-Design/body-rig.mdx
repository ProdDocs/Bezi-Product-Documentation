...
<AccordionGroup>
  ...
  <Accordion title="Using behaviors with the Body Rig" defaultOpen={false}>
    Behaviors that are applied to other objects can target the Body Rig and its children, but the Body Rig cannot have a behavior on it to follow another object.
  </Accordion>
</AccordionGroup>
