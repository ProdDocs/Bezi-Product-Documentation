...
<AccordionGroup>
  <Accordion title="What are States? " defaultOpen={false}>
    States represent the different orientations and positions for an object (e.g. door open and door closed) and animating between the States (e.g. show a door opening and closing)&#x20;
  </Accordion>
