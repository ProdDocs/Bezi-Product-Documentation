...
<AccordionGroup>
  <Accordion title="What are States?" defaultOpen={false}>
    States represent the different states an object can be in and the animations that happen between the various states. &#x20;
  </Accordion>

  <Accordion title="What are States used for?" defaultOpen={false}>
    States are commonly used to show:&#x20;

    1. different options for an object

    2. different orientations and positions for an object (e.g. door open and door closed) and animating between the States (e.g. show a door opening and closing)&#x20;
  </Accordion>
</AccordionGroup>
