...
Input objects are used to define which input device and which keys or buttons are used to trigger an interaction created in the State Machine.&#x20;

Inputs enable binding specific device keys and/or buttons to actions that are used in the State Machine to trigger events.
