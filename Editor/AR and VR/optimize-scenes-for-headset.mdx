...
<AccordionGroup>
  ...
  <Accordion title="Reduce polygon count for 3D models" defaultOpen={false}>
    Models downloaded from external sources that are created to be rendered as photorealistic images have high poly counts, ranging from 50K to millions of polygons.
  </Accordion>
