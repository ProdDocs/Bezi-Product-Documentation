...
<AccordionGroup>
  ...
  <Accordion title="Reduce polygon count for 3D models" defaultOpen={false}>
    ...
    Instead, use models that are low-poly or created for VR. When using models from Sketchfab and Turbosquid, always check the polygon count before downloading.&#x20;
