...
- **Jira**: Automatically pull in issue or feature request tickets to triage by severity and implement in-engine, then log update comments to close the loop on the ticket
...
<iframe src="https://www.youtube.com/embed/sGASNnUOu10" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
