...
Bezi can connect to external tools and services using the Model Context Protocol (MCP). This is best to automatically move data from a tool into Bezi, or automatically update another tool from Bezi. 
