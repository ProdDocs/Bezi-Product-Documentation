...
Image attachments are the best way to give Bezi references for visual work (UI mockup to implement) or more info on parts of Unity it has limited access to (Profiler, ShaderGraph, etc.)
