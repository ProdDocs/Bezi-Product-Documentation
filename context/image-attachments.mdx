...
Image attachments are the best way to give your Bezi agent visual references to copy for a given task. For example, implementing a UI mockup to implement) 
