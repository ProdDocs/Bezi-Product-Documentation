...
1. Confirm the Unity project you’re trying to connect is in a folder with write permissions
2. If you're on Windows, right click on the Bezi app \> `run as administrator`

<Frame>
  ![Failed Install Popup Pn](/images/failed-install-popup.png)
</Frame>

### Why am I seeing a _"_**_Consent Request_**" popup from Unity?
...
<Card title="Asset Sync documentation" icon="pancakes" color="#000000" href="https://docs.bezi.com/bezi/product/asset-sync">
