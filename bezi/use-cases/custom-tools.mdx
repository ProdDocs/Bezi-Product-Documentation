...
<Steps>
  ...
  <Step title="Draft your prompt">
    In <u>as much detail as possible</u>, explain: the high-level process, each step of it, all inputs, variables, or customizations Bezi may need, and the ideal result or outcome. See example prompts below.
