...
description: "Onboard to a new project or get custom documentation of a feature in a heartbeat."
---

Bezi understands the contents of your project, the objects in your scene, and the properties on your assets, so it’s equipped to help you parse through it all to deliver the information you need or locate  find what you need.
...
- _“List all 4K textures”, “What models do I actually use across my scenes?”, “Models that are too high poly to run on mobile”_