...
Pinning allows you to get specific without writing long, asset-packed prompts. Select the objects in Unity and click the `pin` icon next to them in Sidekick's prompt bar to make sure they’re factored into the answer.
