...
> **Pro tip**: Create Rules to ensure specific context or requirements is factored into every response. For **project-specifc rules**, add all your information to the Project Rules doc in Bezi (coming soon). For **thread or prompt specific rules**, describe your idea or requirements in a .TXT file, save it in your Unity project, then pin it to your prompt. 
