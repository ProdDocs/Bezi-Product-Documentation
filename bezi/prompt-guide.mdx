...
Second, on the project-wide scale. Open a Page and document key game information, such as your project's goal, a detailed description of your idea, design pillars, and more. Tag the Page(s) in any prompts/threads where the information will improve Bezi's suggestions and responses. 
...
Bezi does its best to gather the right info, but if you know something is essential, tag it to ensure it's included in the response and to speed up Bezi's reply. Use **@** to search tags while prompting Bezi, or select important stuff while you're in Unity and click the pill(s) that appear above Bezi's input field.
