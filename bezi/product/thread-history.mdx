...
<Info>
  **For optimal response quality, keep threads short and focused on one (1) topic or task**. The longer or more varied a thread, the higher likelihood that Bezi will reference incorrect historical information when processing a response. 
</Info>
