...
<Note>
  **For optimal response quality, keep threads short and focused on one (1) topic or task.** 

  If you prompt in threads with long or multi-task prompt history, Bezi is more likely to accidentally reference the wrong information when processing the response.
</Note>
