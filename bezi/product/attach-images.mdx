---
title: "Attach Images to Prompts"
...
You can attach multiple images (up to 3) to a single prompt. 

There are two ways to attach an image: 

1. Drag and drop the image into the prompt box 
2. Click the attachment icon in the prompt box and select the image file