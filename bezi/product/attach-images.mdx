...
The ability to add images or screenshots to a prompt to supplement the information Bezi factors into the prompt’s response.

## Ideas for using image attachments

Image attachments are helpful in situations where you want to provide Bezi with specific visual context and direction. You can show Bezi things it cannot already see within Unity or exist outside of your project.
