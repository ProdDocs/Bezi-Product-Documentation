...
<Warning>
  **Pin Pages you want Bezi to reference in-prompt**. Bezi includes Pages in the context search, but pinning is the only way to **<u>guaruntee</u>** a Page will be considered in Bezi's context and response.
</Warning>
...
Create an implementation plan with Bezi, then save it in a Page so Bezi can reference and execute on it. **Pin the Page in an Agent Mode prompt and ask Bezi to execute on your plan.**
