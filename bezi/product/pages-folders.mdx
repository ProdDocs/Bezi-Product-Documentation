...
<Warning>
  **You must tag a Page for it to be included in Bezi’s context**. Bezi isn’t able to automatically include all Pages in its context yet, like how Project Rules work, but it's on the roadmap.
</Warning>

**To tag Page(s) in a prompt, type @[page name], press**`enter`**to select, and continue typing your prompt.** It's the same process as referencing an asset or script in a prompt.
