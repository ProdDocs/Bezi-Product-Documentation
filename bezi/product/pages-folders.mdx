...
**To include Pages in a prompt’s context, type @[page name], press **`enter`**to select, and continue typing your prompt. ** It's the same process as referencing an asset or script in a prompt.
