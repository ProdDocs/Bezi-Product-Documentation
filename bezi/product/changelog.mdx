...
<Info>
  **Current app version**: 1.13.1

  **Current Unity plugin version**: 0.53.0
</Info>

<Card title="Download Unity plugin v0.53.0" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.53.0/com.bezi.sidekick-0.53.0.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
...
<Update label="09/30/2025" description>
  ****************************_When you use Bezi to help with game development, memory is crucial. You want it to remember the core premise of your game, a great implementation plan from another thread, or a mechanic’s original state to track changes._****************************
  ...
  [******___We’ve built Pages so you have the power to inject and reinforce these key details without repeating yourself or copy/pasting. Save longer-form project information in Pages and tag them in threads/prompts when a given task builds on them.___******](https://docs.bezi.com/bezi/product/pages-folders)
