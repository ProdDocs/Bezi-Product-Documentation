...
<Info>
  **Current app version**: 1.7.1

  **Current Unity plugin version**: 0.38.8
</Info>

<Card title="Download Unity plugin v0.38.8" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.38.8/com.bezi.sidekick-0.38.8.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
