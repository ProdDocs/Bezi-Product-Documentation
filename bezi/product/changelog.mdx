...
<Card title="Download Bezi plugin v0.57.1" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.57.1/com.bezi.sidekick-0.57.1.tgz" cta="Get the latest plugin if you can't install it via Bezi App">
