...
<Update label="09/30/2025" description>
  ...
  ***We’ve built [Pages](https://docs.bezi.com/bezi/product/pages-folders) so you have the power to inject and reinforce these key details without repeating yourself or copy/pasting. Save longer-form project information in Pages and tag them in threads/prompts when a given task builds on them.***
