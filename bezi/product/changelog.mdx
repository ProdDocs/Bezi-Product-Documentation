...
<Info>
  ...
  **Current plugin version**: 0.53.0
</Info>

<Card title="Download Bezi plugin v0.53.0" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.53.0/com.bezi.sidekick-0.53.0.tgz" cta="Get the latest plugin if you can't install it via Bezi App">
