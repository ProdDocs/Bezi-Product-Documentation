---
title: "Changelog"
description: "Updates and improvements made to Bezi, and the most recent versions of Bezi's app and Unity plugin"
---

<Info>
  **Current Bezi app version**: 1.1.1

  **Current Unity plugin version**: 0.36.0
</Info>

<Card title="Download Unity plugin v0.36.0" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.36.0/com.bezi.sidekick-0.36.0.tgz" cta="Get latest Unity plugin if you can't install via Bezi App">
  Get latest Unity plugin if you can't install via Bezi App
</Card>
