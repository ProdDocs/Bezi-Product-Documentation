...
<Info>
  ...
  **Current Unity plugin version**: 0.42.1
</Info>

<Card title="Download Unity plugin v0.42.1" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.42.1/com.bezi.sidekick-0.42.1.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
