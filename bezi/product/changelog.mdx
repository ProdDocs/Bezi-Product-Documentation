...
<Info>
  ...
  **Current Unity plugin version**: 0.48.2
</Info>

<Card title="Download Unity plugin v0.48.2" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.48.2/com.bezi.sidekick-0.48.2.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
  
</Card>

<Update label="09/30/2025" description>
  _____When you use Bezi to help with game development, memory is crucial. You want it to _____**_____remember the core premise of your game_____**_____, a great implementation plan from another thread, or a _____**_____mechanic’s_____**_____ original state to track changes._____
