...
<Info>
  **Current Bezi app version**: 1.2.0

  **Current Unity plugin version**: 0.38.3
</Info>

<Card title="Download Unity plugin v0.38.3" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.38.3/com.bezi.sidekick-0.38.3.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
