...
<Info>
  ...
  **Current Unity plugin version**: 0.43.4
</Info>

<Card title="Download Unity plugin v0.43.4" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.43.4/com.bezi.sidekick-0.43.4.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
