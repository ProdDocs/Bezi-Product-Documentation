...
<Info>
  **Current app version**: 1.17.1

  **Current plugin version**: 0.60.0
</Info>

<Card title="Download Bezi plugin v0.60.0" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.60.0/com.bezi.sidekick-0.60.0.tgz" cta="Get the latest plugin if you can't install it via Bezi App">
