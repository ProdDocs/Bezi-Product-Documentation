...
<Info>
  ...
  **Current Unity plugin version**: 0.39.0
</Info>

<Card title="Download Unity plugin v0.39.0" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.39.0/com.bezi.sidekick-0.39.0.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
