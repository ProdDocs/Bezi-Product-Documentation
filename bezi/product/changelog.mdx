...
<Card title="Download Unity plugin v0.38.5" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.38.5/com.bezi.sidekick-0.38.5.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
