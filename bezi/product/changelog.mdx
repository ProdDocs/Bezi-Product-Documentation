...
<Info>
  ...
  **Current Unity plugin version**: 0.52.2
</Info>

<Card title="Download Unity plugin v0.52.2" href="https://github.com/bezi3d/bezi-unity-plugin-releases/releases/download/v0.52.2/com.bezi.sidekick-0.52.2.tgz" cta="Get the latest Unity plugin if you can't install it via Bezi App">
...
<Update label="09/30/2025" description>
  ************************_____When you use Bezi to help with game development, memory is crucial. You want it to remember the core premise of your game, a great implementation plan from another thread, or a mechanic’s original state to track changes._____************************
  ...
  ___We’ve built ___[___Pages___](https://docs.bezi.com/bezi/product/pages-folders)___ so you have the power to inject and reinforce these key details without repeating yourself or copy/pasting. Save longer-form project information in Pages and tag them in threads/prompts when a given task builds on them.___
