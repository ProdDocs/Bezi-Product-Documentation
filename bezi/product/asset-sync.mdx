...
The **Asset Sync Errors panel** will indicate if assets have failed to sync or if there is a project-level issue with Asset Sync. To open the Asset Sync Errors panel, click the <Icon icon="bug" iconType="sharp-solid" color="#020202" /> icon in the bottom bar.
