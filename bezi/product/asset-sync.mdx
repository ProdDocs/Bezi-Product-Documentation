...
When connecting a Unity project to Bezi for the first time, Bezi will need time to index the project. **Larger projects will need more time to index**. Once the initial indexing is completed, Bezi will automatically index the project in real-time (as long as its connected) to keep responses relevant to the project.
...
Track Asset Sync's status for the project in the **Asset Sync panel**. To open the panel, click the `server` icon, located in the bottom right of the Bezi app.

<Frame caption="how to open the Asset Sync panel">
