...
<AccordionGroup>
  ...
  <Accordion title="How to know if Asset Sync is done">
    When there are no more assets in the queue, the Asset Sync panel will say “_everything has been synced_”. 

    Please note:**this does not mean all assets were successfully indexed** . To confirm all assets have been successfully synced, check if the Asset Sync Error panel icon (<Icon icon="bug" iconType="sharp-solid" color="#020202" />) has a red dot in it. 

    If there is no red dot, you're ready to prompt\! 

    If there is a red dot, please read on.
  </Accordion>
...
## How do I know if there were Asset Sync issues? 
