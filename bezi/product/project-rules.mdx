...
To access your Project Rules, click the  <Icon icon="sidebar" iconType="regular" color="#000000" />  icon in the top left of your app to open the Sidebar. Within the Sidebar, select `Project Rules` to access the page.