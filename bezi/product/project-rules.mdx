...
<AccordionGroup>
  <Accordion title="ALWAYS write direct, clear instructions — use strong verbs and be specific">
    - **GOOD**: _Follow code style rules defined in _[_MyProjectStyle.md_](http://MyProjectStyle.md)
    - **GOOD**: _NEVER use the Singleton design pattern_


    - BAD: _write good code_
    - BAD: _follow all SOLID principles_
  </Accordion>
