...
4. **Emphasize with strong language**: Use caps and clear words like “ALWAYS,” “IMPORTANT,” and “CRITICAL” to signal weight
...
1. **Do not write rules that use _if_ or _when_**: Rules must be set as universal principles
