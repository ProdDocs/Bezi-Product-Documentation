...
<Steps>
  ...
  <Step title="Install the Bezi plugin in Unity">
    ...
    <img
      src="/images/InstallPluginCenter.png"
      alt="Install Plugin Center Pn"
      className="mx-auto"
    />
  ...
  <Step title="Confirm connection status">
    ...
    <Frame>
      ...
      ![Unity Connected Pn](/images/unity-connected.png)
    </Frame>
    <Frame>
      Bezi connected

      ![Bezi Connected Pn](/images/bezi-connected.png)
    </Frame>
