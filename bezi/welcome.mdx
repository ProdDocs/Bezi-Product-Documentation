...
We’ve invested in top-tier IP security so your project data is never at risk of being mishandled or exposed. Among other things, **no project data is ever used to train models**. We encourage you to review our [security program and FAQs](https://docs.bezi.com/bezi/security). For any security-related questions, email [security@bezi.com](mailto:security@bezi.com).
