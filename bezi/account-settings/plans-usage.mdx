...
See [bezi.com/pricing](https://www.bezi.com/pricing) for information on Bezi Plan options. 

Custom plans are available for custom model selection, advanced security or SSO, custom credit limits, admin dashboards, and centralized billing. 
