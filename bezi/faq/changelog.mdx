...
<Update label="02/06/2025">
  Sidekick's Unity plugin is now installed locally per Unity project, for optimal performance please uninstall the existing Unity plugin, then follow app instructions to install the new plugin \_
