...
Agent Mode will directly implement changes in Unity on your behalf, while [Ask Mode](https://docs.bezi.com/bezi/modes/ask-mode) cannot. Consider Agent Mode as **automatic** implementation and Ask Mode as **manual** implementation.
