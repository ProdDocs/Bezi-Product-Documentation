...
This functionality is similar to the [Edit Prompt](https://docs.bezi.com/bezi/product/edit-prompts) functionality, but it allows you to return to a specific _response_ without anything regenerating (whereas with Editing, you have to modify a prompt and therefore regenerate it’s results to return to that point).