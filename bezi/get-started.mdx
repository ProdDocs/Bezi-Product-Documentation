...
<Steps>
  ...
  <Step title="Complete Asset Sync for the project">
    The first time you connect Bezi to a Unity project, it needs a time to sync and make sense of what’s in the project. This enables Bezi to adapt all responses to your project. It’s important not to prompt Bezi until Asset Sync is completed, otherwise you risk receiving generic responses.
  </Step>
</Steps>
