...
**Bezi (codename Sidekick) is still in alpha**.&#x20;
...
Please report any issues or confusion in the [Discord channel](https://discord.gg/xdSTX8JT8K). We'll reply as fast as possible. Fixing any perceived issues may require asking you more questions to diagnose and resolve the root cause, not just the symptom.
...
<Steps>
  <Step title="Create an account">
    ...
    <Note>
      You must create an account using the email address you received your access email at. If you want to use a different email, send us a note in the [Discord channel](https://discord.gg/cTraeg3n)
    </Note>
  </Step>

  <Step title="Start your free trial">
    After your account is created, you'll be redirected to the [Get Sidekick](https://bezi.com/start?source=sidekick) page. Complete the free trial flow before you download the Bezi app.
