...
Please report any issues or confusion in the [Discord channel](https://discord.com/invite/UKWB46HTT9). We'll reply as fast as possible. Fixing any perceived issues may require asking you more questions to diagnose and resolve the root cause, not just the symptom.
...
<Steps>
  <Step title="Create an account">
    ...
    <Note>
      You must create an account using the email address you received your access email at. If you want to use a different email, send us a note in the [Discord channel](https://discord.com/invite/UKWB46HTT9)
    </Note>
  </Step>
